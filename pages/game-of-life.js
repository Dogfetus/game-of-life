...
var ASM_CONSTS = {
  106948: () => { if (document.fullscreenElement) return 1; },  
 106994: () => { return document.getElementById('canvas').width; },  
 107046: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107114: () => { document.exitFullscreen(); },  
 107141: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107214: () => { if (document.fullscreenElement) return 1; },  
 107260: () => { return document.getElementById('canvas').width; },  
 107312: () => { return screen.width; },  
 107337: () => { document.exitFullscreen(); },  
 107364: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107497: () => { return window.innerWidth; },  
 107523: () => { return window.innerHeight; },  
 107550: () => { if (document.fullscreenElement) return 1; },  
 107596: () => { return document.getElementById('canvas').width; },  
 107648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107716: () => { if (document.fullscreenElement) return 1; },  
 107762: () => { return document.getElementById('canvas').width; },  
 107814: () => { return screen.width; },  
 107839: () => { return window.innerWidth; },  
 107865: () => { return window.innerHeight; },  
 107892: () => { if (document.fullscreenElement) return 1; },  
 107938: () => { return document.getElementById('canvas').width; },  
 107990: () => { return screen.width; },  
 108015: () => { document.exitFullscreen(); },  
 108042: () => { if (document.fullscreenElement) return 1; },  
 108088: () => { return document.getElementById('canvas').width; },  
 108140: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108208: () => { document.exitFullscreen(); },  
 108235: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108293: () => { return screen.width; },  
 108318: () => { return screen.height; },  
 108344: () => { return window.screenX; },  
 108371: () => { return window.screenY; },  
 108398: () => { return window.devicePixelRatio; },  
 108434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108942: () => { if (document.fullscreenElement) return 1; },  
 108988: () => { return window.innerWidth; },  
 109014: () => { return window.innerHeight; },  
 109041: () => { if (document.pointerLockElement) return 1; }
};
